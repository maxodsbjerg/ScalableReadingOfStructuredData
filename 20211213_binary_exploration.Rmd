...
## How many of the tweets from our data are verified accounts
...
In the next step you calculate the means for retweets and reply following the same method as you did with the favorite count:
```{r}
interactions %>% 
  add_row(
    sesamestreet_data %>% 
